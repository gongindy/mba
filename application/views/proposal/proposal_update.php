  ...
  <div class="main-content-inner"> 
    ...
    <div class="breadcrumbs" id="breadcrumbs"> 
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">แก้ไขแบบเสนอร่างโครงการ</li>
      </ul>
      <!-- /.breadcrumb --> 
    ...
    <div class="page-content"> 
      ...
      <div class="page-header">
        <h1> แก้ไขแบบเสนอร่างโครงการ <small> <i class="ace-icon fa fa-angle-double-right"></i> overview &amp; stats </small> </h1>
      </div>
      <!-- /.page-header --> 
      <!-- start -->
      ...
      <div class="row">
        <div class="col-xs-12"> 
          ...
          <?php echo form_open('proposal/do_update',$att);?> 
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" name="pro_name" id="pro_name" placeholder="กรุณากรอกชื่อโครงการ.." class="col-xs-10 col-sm-5" required="required" value="<?php echo $proposal[0]['pro_name'];?>" />
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form-field-1" >ลักษณะโครงการ</label>
				...
				<div class="col-sm-9">
                	<label>
                        <input name="pro_category" type="radio" class="ace" required="required" <?=$proposal[0]['pro_category']==1 ? 'checked' : '' ?> value="1" />
                    	<span class="lbl">โครงการเดิม</span>
					</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												
                    <label>
                        <input name="pro_category" type="radio" class="ace" <?=$proposal[0]['pro_category']==2 ? 'checked' : '' ?> value="2"/>
                        <span class="lbl">โครงการต่อเนื่อง</span>
                    </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            
                    <label>
                        <input name="pro_category" type="radio" class="ace" <?=$proposal[0]['pro_category']==3 ? 'checked' : '' ?> value="3"/>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="pro_target"  value="<?php echo $proposal[0]['pro_target'];?>" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> หน่วยงานผู้รับผิดชอบ/ผู้รับผิดชอบโครงการ</label>
            <div class="col-sm-9">
              <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="pro_social"  value="<?php echo $proposal[0]['pro_social'];?>"/>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> สถานที่และระยะเวลา</label>
            <div class="col-sm-9">
              <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="pro_location"  value="<?php echo $proposal[0]['pro_location'];?>"/>
            </div>
            ...
            <div class="col-sm-9" style="padding-top:1.1em;">
              <div class="input-group"> <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span>
                <input type="text" name="date_location" id="daterange" class="col-xs-10 col-sm-3"  value="<?php echo $proposal[0]['pro_date'];?>"/>
              </div>
            </div>
          </div>
          <hr/>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-11">
              <div class="dd dd-draghandle">
                ...
                <?php $i_improve = 1 ; ?>
              <?php foreach($improve as $improve_1) { ?>
                  <li class="dd-item dd2-item" id="li_improve_<?= $i_improve; ?>">
                    ...
                    <div class="dd2-content" style="padding-bottom:0em; padding-top:0.3em; padding-right:0em; height:4em;">
                      <input type"text" name="txt_improve[]" style="padding:0; width:90%; color:#000; font-weight:normal; height:3.2em;"  value="<?php echo $improve_1['improve_content'];?>"/>&nbsp;&nbsp;<button type="button" class="btn btn-danger" onclick="rem('li_improve_<?= $i_improve; ?>');" style="padding:0em; top:-0.1em; margin:0em; width:3em; height:3em;">&nbsp;<i class="ace-icon fa fa-trash-o bigger-120"></i></button>
                    </div>
                  </li>
              <?php $i_improve++; } ?>
                </ol>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-11">
              ...
              <?php $i_rationalel = 1; ?>
              <?php foreach($rationale as $rationale_1) { ?>
                  <li class="dd-item dd2-item" id="li_rationale_<?=$i_rationalel?>">
                    ...
                    <div class="dd2-content" style="padding-bottom:0em; padding-top:0.3em; padding-right:0em; height:9.5em;">
                      <textarea class="autosize-transition col-xs-10 col-sm-5" name="txt_rationale[]" style="padding:0; width:90%; color:#000; font-weight:normal; height:8em; resize:none;" ><?php echo $rationale_1['rationale_content'];?></textarea>
                      &nbsp;
                      <button type="button" class="btn btn-danger" onclick="rem('li_rationale_<?=$i_rationalel?>');" style="padding:0em; top:-0.1em; margin:0em; width:3em; height:3em;">&nbsp;<i class="ace-icon fa fa-trash-o bigger-120"></i></button>
                    </div>
                  </li>
                <?php $i_rationalel++; } ?>
                </ol>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-11">
              <div class="dd dd-draghandle">
                ...
                <?php $i_objective = 1 ;?>
              <?php foreach($objective as $objective_1) { ?>
                  <li class="dd-item dd2-item" id="li_objective_<?=$i_objective?>">
                    <div class="dd-handle dd2-handle" style="height:4em;"><i class="ace-icon fa fa-comment bigger-110"></i></div>
                    <div class="dd2-content" style="padding-bottom:0em; padding-top:0.3em; padding-right:0em; height:4em;">
                      <input type"text" name="txt_objective[]" style="padding:0; width:90%; color:#000; font-weight:normal; height:3.2em;"  value="<?php echo $objective_1['objective_content'];?>"/>&nbsp;&nbsp;<button type="button" class="btn btn-danger" onclick="rem('li_objective_<?=$i_objective?>');" style="padding:0em; top:-0.1em; margin:0em; width:3em; height:3em;">&nbsp;<i class="ace-icon fa fa-trash-o bigger-120"></i></button>
                    </div>
                  </li>
                <?php $i_objective++; } ?>
                </ol>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-11">
              <div class="dd dd-draghandle">
                ...
                <?php $i_benefit = 1 ;?>
                <?php foreach($benefit as $benefit_1) { ?>
                  <li class="dd-item dd2-item" id="li_benefit_<?=$i_benefit?>">
                    <div class="dd-handle dd2-handle" style="height:4em;"><i class="ace-icon fa fa-comment bigger-110"></i></div>
                    <div class="dd2-content" style="padding-bottom:0em; padding-top:0.3em; padding-right:0em; height:4em;">
                      <input type"text" name="txt_benefit[]" style="padding:0; width:90%; color:#000; font-weight:normal; height:3.2em;"  value="<?php echo $benefit_1['benefit_content'];?>"/>&nbsp;&nbsp;<button type="button" class="btn btn-danger" onclick="rem('li_benefit_<?=$i_benefit?>');" style="padding:0em; top:-0.1em; margin:0em; width:3em; height:3em;">&nbsp;<i class="ace-icon fa fa-trash-o bigger-120"></i></button>
                    </div>
                  </li>
                  <?php $i_benefit++; } ?>
                </ol>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-11">
              <div class="dd dd-draghandle">
                ...
                <?php $i_plan = 1 ;?>
                <?php foreach($plan as $plan_1) { ?>
                  <li class="dd-item dd2-item" id="li_plan_<?=$i_plan;?>">
                    <div class="dd-handle dd2-handle" style="height:4em;"><i class="ace-icon fa fa-comment bigger-110"></i></div>
                    <div class="dd2-content" style="padding-bottom:0em; width:57em; padding-top:0.22em; padding-right:0em; height:4em;">	
                      <div class="col-sm-11" style="padding:0; margin:0;">
                        <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="txt_plan[]" style="padding:0; width:30em; color:#000; font-weight:normal; height:3.2em;"  value="<?php echo $plan_1['plan_content'];?>"/>
                        <div clas="col-sm-1">
                          <div class="input-group" style="padding-left:0.6em;"> <span class="input-group-addon"> <i class="fa fa-calendar bigger-110"></i> </span>
                            <input type="text" name="date_plan[]" id="daterange" class="col-xs-10 col-sm-5" style="height:3.2em; width:12em;"  value="<?php echo date('d-m-Y' ,strtotime($plan_1['plan_start']));?> - <?php echo date('d-m-Y' ,strtotime($plan_1['plan_end']));?>"/>
                          </div>
                        </div>
                      </div>
                      &nbsp;
                      <button type="button" class="btn btn-danger" onclick="rem('li_plan_<?=$i_plan;?>');" style="padding:0em; top:0.05em; margin:0em; width:3em; height:3em;">&nbsp;<i class="ace-icon fa fa-trash-o bigger-120"></i></button>
                    </div>
                  </li>
                  <?php $i_plan++; } ?>
                </ol>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-11">
              <div class="dd dd-draghandle">
                ...
                <?php $i_budget = 1 ;?>
                <?php foreach($budget as $budget_1) { ?>
                  <li class="dd-item dd2-item" id="li_budget_<?=$i_budget;?>">
                    <div class="dd-handle dd2-handle" style="height:4em;"><i class="ace-icon fa fa-comment bigger-110"></i></div>
                    <div class="dd2-content" style="padding-bottom:0em; width:57em; padding-top:0.22em; padding-right:0em; height:4em;">
                      <div class="col-sm-11" style="padding:0; margin:0;">
                        <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="txt_budget[]" style="padding:0; width:30em; color:#000; font-weight:normal; height:3.2em;"  value="<?php echo $budget_1['budget_content'];?>"/>
                        <div clas="col-sm-1">
                          <div class="input-group" style="padding-left:0.6em;"> <span class="input-group-addon"> <i class="fa fa-money bigger-110"></i> </span>
                            <input type="number" name="budget[]" class="col-xs-10 col-sm-5" style="height:3.2em; width:12em;" onChange="sum_budget()" onkeypress="check_num()"  value="<?php echo $budget_1['budget_cost'];?>"/>
                          </div>
                        </div>
                      </div>
                      &nbsp;
                      <button type="button" class="btn btn-danger" onclick="rem('li_budget_<?=$i_budget;?>');" style="padding:0em; top:0.05em; margin:0em; width:3em; height:3em;">&nbsp;<i class="ace-icon fa fa-trash-o bigger-120"></i></button>
                    </div>
                  </li>
                  <?php $i_budget++;} ?>
                </ol>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-11">
              <div class="dd dd-draghandle">
                ...
                <?php $i_indicator = 1;?>
                <?php foreach($indicator as $indicator_1) { ?>
                  <li class="dd-item dd2-item" id="li_indicator_<?=$i_indicator?>">
                    ...
                    <div class="col-sm-12" style="padding:0; margin-bottom:10px; ">
                      <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="indicator_name[]" style="padding:0; width:30em; color:#000; font-weight:normal; height:3.2em;"  placeholder="ชื่อตัวชี้วัด" value="<?php echo $indicator_1['indicator_name'];?>"/>&nbsp;
                        <button type="button" class="btn btn-danger" onclick="rem('li_indicator_<?=$i_indicator?>');" style="padding:0em; top:0.05em; margin:0em; width:3em; height:3em;">&nbsp;<i class="ace-icon fa fa-trash-o bigger-120"></i></button>						</div>
                        <div class="col-sm-12" style="padding:0; margin-bottom:10px;">
                        <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="indicator_unit[]" style="margin-right:8px; padding:0; width:14.7em; color:#000; font-weight:normal; height:3.2em;"  placeholder="หน่วยนับ" value="<?php echo $indicator_1['indicator_unit'];?>"/>
                         <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="indicator_value[]" style="padding:0; width:14.7em; color:#000; font-weight:normal; height:3.2em;"  placeholder="ค่าเป้าหมาย" value="<?php echo $indicator_1['indicator_value'];?>"/>
                        
                        </div>
                        
                        <div class="col-sm-12" style="padding:0;">
                      <textarea style="padding:0; width:30em; color:#000; font-weight:normal; height:12em;" placeholder="เกณฑ์" name="indicator_level[]" ><?php echo str_replace("<br />", "",$indicator_1['indicator_level']);?></textarea>
                       					</div>
                    </div>
                  </li>
                  <?php $i_indicator++;} ?>
          ...
          <div class="clearfix form-actions">
            <div class="col-md-offset-3 col-md-9">
              ...
              <button class="btn" type="button"> <i class="ace-icon fa fa-undo bigger-110"></i> ย้อนกลับ </button>
              </a>
...
var count_improve = <?= $i_improve; ?>;
var count_rationale = <?= $i_rationalel;?>;
var count_objective = <?=$i_objective?>;
var count_benefit = <?=$i_benefit?>;
var count_plan = <?=$i_plan?>;
var count_budget = <?=$i_budget;?>;
var count_indicator = <?=$i_indicator?>;
