		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<ul class="nav nav-list">
					<li class="<?php if($this->uri->segment(1) == 'proposal') {echo 'active open';}?>">
						<a href="#" class="dropdown-toggle">
							<i class="menu-icon fa fa-list"></i>จัดการโครงการ<b class="arrow fa fa-angle-down"></b>
						</a>
						...
						<ul class="submenu">
							<li class="">
								<a href="<?php echo site_url('proposal/add');?>">
									<i class="menu-icon fa fa-caret-right"></i>
									สร้างแบบเสนอโครงการใหม่
								</a>
					...
					<li class="<?php if(strpos($this->uri->segment(1),'etting')) {echo 'active open';}?>">
						<a href="#" class="dropdown-toggle">
							<i class="menu-icon fa fa-gear"></i>ตั้งค่าระบบ<b class="arrow fa fa-angle-down"></b>
						</a>
						...
						<ul class="submenu">
							<li class="">
								<a href="<?php echo site_url('setting_strategic');?>">
									<i class="menu-icon fa fa-caret-right"></i>
									จัดการประเด็นยุทธศาสตร์
								</a>

								<b class="arrow"></b>
							</li>
							<li class="">
								<a href="<?php echo site_url('setting_year');?>">
									<i class="menu-icon fa fa-caret-right"></i>
									จัดการปีงบประมาณ
								</a>
